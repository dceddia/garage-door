...
/**
 * Reads the value asynchronously, and calls the given callback with the current value
 * Also saves the new value in self.value
 */
GPIO.prototype.get = function(fn) {
